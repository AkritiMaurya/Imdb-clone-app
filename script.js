//API Key - d1b4af9
//Example - http://www.omdbapi.com/?i=tt3896198&apikey=d1b4af9
...
fetch('http://www.omdbapi.com/?i=tt3896198&apikey=d1b4af9')
    .then(res => res.json())
...
async function singleMovie() {
    ...
    // Making the output html by string interpolition//bactic used
    var output = `
...
async function removeFromfavorites(id) {
    ...
    alert('your Movie Removed from Favourite');
...
async function displayMovieList(movies) {
    ...
    for (i of movies) {
        ...
        <div class="fav-item">
            ...
            <a href="movie.html?id=${id}"target="_blank"><img src=${img} alt="Favourites Poster"></a>
            </div>
